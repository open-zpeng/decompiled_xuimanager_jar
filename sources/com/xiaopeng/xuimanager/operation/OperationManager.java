...
public class OperationManager implements XUIManagerBase {
    ...
    public void downloadResource(boolean useSystemTraffic, OperationResource resource, OpenAction openAction) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.operateResource("download_resource", resource.getResourceType(), ResourceBuild.toJsonWithDownloadParams(resource, useSystemTraffic, openAction).toString());
    ...
    public void cancelDownload(OperationResource resource) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.operateResource(OperationCmd.CANCEL_DOWNLOAD_RESOURCE, resource.getResourceType(), ResourceBuild.toJson(resource).toString());
    ...
    public void pauseDownload(OperationResource resource) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.operateResource(OperationCmd.PAUSE_DOWNLOAD_RESOURCE, resource.getResourceType(), ResourceBuild.toJson(resource).toString());
    ...
    public void resumeDownload(OperationResource resource) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.operateResource(OperationCmd.RESUME_DOWNLOAD_RESOURCE, resource.getResourceType(), ResourceBuild.toJson(resource).toString());
    ...
    public void setAutoSync(int type) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.operateResource(OperationCmd.SET_AUTO_SYNC_RESOURCE, type, "");
    ...
    public void getRemoteResourceList(int type) {
        if (this.mOperationService != null) {
            try {
                this.mOperationService.getResource(type, OperationParams.PARAMS_GET_REMOTE);
    ...
    public List<OperationResource> getResourceList(int type) {
        ...
        if (this.mOperationService != null) {
            try {
                result = this.mOperationService.getResource(type, "");
    ...
    public OperationResource getSelectedResource(int type) {
        ...
        if (this.mOperationService != null) {
            try {
                result = this.mOperationService.getResource(type, OperationParams.PARAM_GET_SELECTED);
    ...
    public List<DownloadStatusInfo> getDownloadStatusList(int type) {
        ...
        if (this.mOperationService != null) {
            try {
                result = this.mOperationService.getInfo(OperationCmd.GET_DOWNLOAD_STATUS_LIST, type, "");
