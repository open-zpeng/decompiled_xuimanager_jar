...
public interface IBTStatusListener extends IInterface {
    ...
    public static class Default implements IBTStatusListener {
        ...
        public void onBtStatusChanged(int status) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IBTStatusListener {
        ...
        public static IBTStatusListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IBTStatusListener)) {
                return (IBTStatusListener) iin;
            }
            ...
            public void onBtStatusChanged(int status) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onBtStatusChanged(status);
                    } else {
        ...
        public static boolean setDefaultImpl(IBTStatusListener impl) {
