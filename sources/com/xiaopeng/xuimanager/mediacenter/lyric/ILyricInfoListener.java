...
public interface ILyricInfoListener extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static class Default implements ILyricInfoListener {
    ...
    public static abstract class Stub extends Binder implements ILyricInfoListener {
        ...
        /* loaded from: classes.dex */
        public static class Proxy implements ILyricInfoListener {
            public static ILyricInfoListener sDefaultImpl;
            ...
            public void onLyricInfoUpdated(int displayId, LyricInfo lyricInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onLyricInfoUpdated(displayId, lyricInfo);
                    } else {
        ...
        public static boolean setDefaultImpl(ILyricInfoListener impl) {
        ...
        public static ILyricInfoListener getDefaultImpl() {
