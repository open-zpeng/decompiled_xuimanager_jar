...
public class MediaCenterManager implements XUIManagerBase {
        ...
        if (this.mBTStatusListeners.isEmpty()) {
            try {
                try {
                    ...
                    XUIManager.checkXUIServiceNotConnectedExceptionFromXUIService(ex);
                }
            } catch (RemoteException ex2) {
                Log.e(TAG, "Could not connect: " + ex2.toString());
                throw new XUIServiceNotConnectedException(ex2);
            }
        }
    ...
    public void requestMediaButton(boolean request, Bundle extras) {
        ...
        if (iMediaCenter != null) {
            try {
                iMediaCenter.requestMediaButton(request, extras);
            } catch (RemoteException e) {
    ...
    public AvrcpMeteData getAvrcpMeteData() {
        ...
        if (iMediaCenter != null) {
            try {
                return iMediaCenter.getAvrcpMeteData();
            } catch (RemoteException e) {
