...
public class MediaInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (this.mAlbumBmp != null && !this.mAlbumBmp.isRecycled()) {
            dest.writeInt(1);
    ...
    private static int getColor(int mediaStyle) {
        if (mediaStyle < 0 || mediaStyle >= STYLECOLOR.length) {
            return 5;
        }
        int color = STYLECOLOR[mediaStyle];
        return color;
    }
    ...
    public void putString(String key, String value) {
        ...
        if (this.mExtras != null) {
            this.mExtras.putCharSequence(key, value);
        }
    }
