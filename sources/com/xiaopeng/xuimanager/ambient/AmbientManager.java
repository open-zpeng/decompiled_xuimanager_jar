...
public class AmbientManager implements XUIManagerBase {
    ...
    public Pair<Color, Color> getAmbientLightDoubleColor(String partition) throws XUIServiceNotConnectedException {
        try {
            List<Integer> res = (List) this.mService.getAmbientLightDoubleColor(partition).stream().map(new Function() { // from class: com.xiaopeng.xuimanager.ambient.-$$Lambda$JWLUSa4hQWAZf1TfuyVGazguidI
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
