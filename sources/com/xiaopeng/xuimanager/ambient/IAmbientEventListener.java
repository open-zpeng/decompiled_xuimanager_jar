...
public interface IAmbientEventListener extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static class Default implements IAmbientEventListener {
    ...
    public static abstract class Stub extends Binder implements IAmbientEventListener {
        ...
        /* loaded from: classes.dex */
        public static class Proxy implements IAmbientEventListener {
            public static IAmbientEventListener sDefaultImpl;
            ...
            public void onAmbientLightEvent(int type, String sdata, String sdata2, int data) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onAmbientLightEvent(type, sdata, sdata2, data);
                    }
                } finally {
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(IAmbientEventListener impl) {
        ...
        public static IAmbientEventListener getDefaultImpl() {
