...
public interface IAmbient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAmbient {
        ...
        /* loaded from: classes.dex */
        private static class Proxy implements IAmbient {
            ...
            public int setAmbientLightMonoColor(String partition, int color) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAmbientLightMonoColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getAmbientLightMonoColor(String partition) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(partition);
                    this.mRemote.transact(Stub.TRANSACTION_getAmbientLightMonoColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setAmbientLightDoubleColor(String partition, int first, int second) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAmbientLightDoubleColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public List<String> getAmbientLightDoubleColor(String partition) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(partition);
                    this.mRemote.transact(Stub.TRANSACTION_getAmbientLightDoubleColor, _data, _reply, 0);
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    return _result;
                } finally {
            ...
            public List<String> showAmbientLightThemesColor() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_showAmbientLightThemesColor, _data, _reply, 0);
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    return _result;
                } finally {
            ...
            public int setAmbientLightThemeColor(String partition, String themeColor) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setAmbientLightThemeColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public String getAmbientLightThemeColor(String partition) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(partition);
                    this.mRemote.transact(Stub.TRANSACTION_getAmbientLightThemeColor, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
            ...
            public List<String> showAmbientLightRegions() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_showAmbientLightRegions, _data, _reply, 0);
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    return _result;
                } finally {
            ...
            public int setAmbientLightRegionColor(String partition, String region, int color) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(color);
                    this.mRemote.transact(Stub.TRANSACTION_setAmbientLightRegionColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getAmbientLightRegionColor(String partition, String region) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(partition);
                    _data.writeString(region);
                    this.mRemote.transact(Stub.TRANSACTION_getAmbientLightRegionColor, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setAmbientLightRegionBright(String partition, String region, int bright) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(region);
                    _data.writeInt(bright);
                    this.mRemote.transact(Stub.TRANSACTION_setAmbientLightRegionBright, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
