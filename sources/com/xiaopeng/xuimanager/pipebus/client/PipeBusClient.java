...
public final class PipeBusClient {
    ...
    public int ioControl(String module, String cmd, String[] params) {
        ...
        if (iPipeBus != null) {
            try {
                ret = iPipeBus.ioControl(module, cmd, params);
            } catch (Exception e) {
                String str = this.TAG;
        ...
        if (this.mPipeBusClient == null) {
            ...
            if (binder != null) {
                ...
                try {
                    ...
                    String str = this.TAG;
                    LogUtil.w(str, "linkToDeath exception=" + e.getMessage() + ",binder=" + binder + ",mDeathRecipient=" + this.mDeathRecipient);
                }
                this.mPipeBusClient = IPipeBus.Stub.asInterface(binder);
                this.connectRetryCount = 0;
            } else if (!this.mModuleListenerMap.isEmpty() && (i = this.connectRetryCount) < MAX_RETRY_CNT) {
