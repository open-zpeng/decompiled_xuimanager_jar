    ...
    public void processEvent(String types, String[] events) {
        ...
        if (list == null) {
            ...
            switch (types.hashCode()) {
                case -333836685:
                    if (types.equals(IoTCommunication.EVENT_PROPERTY_UPDATE)) {
                        c = 1;
                        break;
                    }
                    break;
                case 781495096:
                    if (types.equals(IoTCommunication.EVENT_DEVICE_ADD)) {
                        c = 0;
                        break;
                    }
                    break;
                case 1438668277:
                    if (types.equals(IoTCommunication.EVENT_PROPERTY_UPDATE_WITH_JSON)) {
                        c = 2;
                        break;
                    }
                    break;
                case 1532124661:
                    if (types.equals(IoTCommunication.EVENT_OPERATION_RESULT)) {
                        c = 3;
                        break;
                    }
                    break;
            ...
            } else if (c == 3 && events != null && events.length > 2) {
    ...
    public List<BaseDevice> getDevice(String getType, String params) {
        ...
        if (iPipeBus != null) {
            try {
                ...
                iPipeBus.ioControlWithPocket(IoTCommunication.MODULE_IOT, IoTCommunication.IO_GET_DEVICE, args, results);
                if (results.length > 0) {
                    String str2 = TAG;
    ...
    public void requestDeviceList(String deviceFilter) {
        ...
        if (iPipeBus != null) {
            try {
                ...
                iPipeBus.ioControl(IoTCommunication.MODULE_IOT, IoTCommunication.IO_REQUEST_DEVICE, params);
            } catch (Exception e) {
                String str2 = TAG;
