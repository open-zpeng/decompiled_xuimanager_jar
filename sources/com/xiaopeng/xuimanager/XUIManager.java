...
public class XUIManager {
    ...
    private XUIManager() {
        ...
        this.mMainThreadEventHandler.post(new Runnable() { // from class: com.xiaopeng.xuimanager.-$$Lambda$XUIManager$l0fKIG_RuwR0S7d5i8db985cD-c
            ...
            public final void run() {
                XUIManager.this.lambda$new$0$XUIManager();
            }
        });
    }
    ...
    public void lambda$new$0$XUIManager() throws IllegalStateException {
        synchronized (this) {
    ...
    private XUIManagerBase createXUIServiceManager(String serviceName, IBinder binder) throws XUIServiceNotConnectedException {
        ...
        switch (serviceName.hashCode()) {
            ...
            case -861311717:
                ...
                break;
            case -601874003:
                if (serviceName.equals(MAKEUPLIGHT_SERVICE)) {
                    c = 7;
                    break;
                }
                c = 65535;
        ...
        switch (c) {
            ...
            case 6:
                ...
                return manager7;
            case 7:
                XUIManagerBase manager8 = new MakeupLightManager(binder, this.mContext, this.mEventHandler);
                return manager8;
            case '\b':
                XUIManagerBase manager9 = new SeatMassagerManager(binder, this.mContext, this.mEventHandler);
                return manager9;
            case '\t':
                XUIManagerBase manager10 = new MediaCenterManager(binder, this.mContext, this.mEventHandler);
                return manager10;
            case '\n':
                XUIManagerBase manager11 = new MusicRecognizeManager(binder, this.mContext, this.mEventHandler);
                return manager11;
            case 11:
                XUIManagerBase manager12 = new XAppManager(binder, this.mContext, this.mEventHandler);
                return manager12;
            case '\f':
                XUIManagerBase manager13 = new OperationManager(binder, this.mContext, this.mEventHandler);
                return manager13;
            case '\r':
                XUIManagerBase manager14 = new KaraokeManager(binder, this.mContext, this.mEventHandler);
                return manager14;
            case 14:
                XUIManagerBase manager15 = IoTManager.getInstance();
                ((IoTManager) manager15).init(this.mContext);
                return manager15;
            case 15:
                XUIManagerBase manager16 = new UserScenarioManager(binder, this.mContext, this.mEventHandler);
                return manager16;
            case 16:
                XUIManagerBase manager17 = ThemeOperationManager.getInstance();
                manager17.init(binder, this.mContext, this.mEventHandler);
                return manager17;
            case 17:
                XUIManagerBase manager18 = SoundResourceManager.getInstance();
                manager18.init(binder, this.mContext, this.mEventHandler);
                return manager18;
            case 18:
                XUIManagerBase manager19 = ConditionManager.getInstance();
                manager19.init(binder, this.mContext, this.mEventHandler);
                return manager19;
            case 19:
                XUIManagerBase manager20 = MessageManager.getInstance();
