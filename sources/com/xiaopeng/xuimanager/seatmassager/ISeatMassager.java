...
public interface ISeatMassager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISeatMassager {
        ...
        /* loaded from: classes.dex */
        private static class Proxy implements ISeatMassager {
            ...
            public int setRhythmIntensity(List<String> ids, int intensity) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStringList(ids);
                    _data.writeInt(intensity);
                    this.mRemote.transact(Stub.TRANSACTION_setRhythmIntensity, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getRhythmIntensity(int id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(id);
                    this.mRemote.transact(Stub.TRANSACTION_getRhythmIntensity, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int setRhythmPattern(int pattern) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_setRhythmPattern, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getRhythmPattern() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRhythmPattern, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
