            ...
            if (listeners.isEmpty()) {
                try {
                    try {
                        ...
                        XUIManager.checkXUIServiceNotConnectedExceptionFromXUIService(e);
                    }
                } catch (RemoteException e2) {
                    String str = TAG;
                    LogUtil.e(str, "IMessage.registerMessage fail, " + e2.getMessage());
                    e2.printStackTrace();
                    throw new XUIServiceNotConnectedException(e2);
                }
            }
