...
public class ThemeOperationManager implements AbsThemeOperation, XUIManagerBase {
    ...
    /* loaded from: classes.dex */
    private static class ThemeOperationManagerHolder {
    ...
    public void onXUIDisconnected() {
        ...
        ThemeOperationListenerImpl themeOperationListenerImpl = this.themeOperationListenerImpl;
        if (themeOperationListenerImpl != null) {
            try {
                this.mService.unRegisterListener(themeOperationListenerImpl);
            } catch (RemoteException e) {
                String str = TAG;
    ...
    public void onXUIConnected(IBinder service) {
        ...
        if (themeOperationListenerImpl != null) {
            try {
                this.mService.registerListener(themeOperationListenerImpl);
            } catch (Exception e) {
                String str = TAG;
