...
public class UserScenarioManager implements XUIManagerBase {
    ...
    public static final String SCENARIO_ECALL = "ecall_mode";
    public static final int SCENARIO_ECALL_VAL = 14;
    public static final String SCENARIO_EOL = "eol_mode";
    public static final int SCENARIO_EOL_VAL = 15;
    ...
    public static final String SCENARIO_OOBE = "oobe_mode";
    public static final int SCENARIO_OOBE_VAL = 16;
    ...
    private static void initNameValueMap() {
        ...
        mScenarioNameValueMap.put(SCENARIO_ECALL, 14);
        mScenarioNameValueMap.put(SCENARIO_EOL, 15);
        mScenarioNameValueMap.put(SCENARIO_OOBE, 16);
    }
    ...
    public void reportStatus(String scenario, int status) {
        ...
        try {
            this.mService.reportStatus(scenario, status);
        } catch (RemoteException e) {
            String str = TAG;
    ...
    public String registerBinderObserver(IBinder binder) {
        ...
        try {
            this.mService.registerBinderObserver(binder);
            return RET_SUCCESS;
        } catch (RemoteException e) {
            String str = TAG;
    ...
    public String registerBinderObserver(IBinder binder, String scenario) {
        return registerBinderObserver(binder);
    }
    ...
    public String checkEnterUserScenario(String scenario, String source) {
        ...
        try {
            String ret = this.mService.checkEnterUserScenario(scenario, source);
            return ret;
        } catch (Exception e) {
            String str = TAG;
    ...
    public String setParameters(String scenario, String jsonStr) {
        ...
        try {
            String ret = this.mService.setParameters(scenario, jsonStr);
            return ret;
        } catch (Exception e) {
            String str = TAG;
    ...
    public String enqueueScenario(String scenario, boolean queueOrNot, String param) {
        String str = TAG;
        Log.w(str, "enqueueScenario,not supported yet,scenario=" + scenario);
        return RET_SCENARIO_INVALID;
    }
