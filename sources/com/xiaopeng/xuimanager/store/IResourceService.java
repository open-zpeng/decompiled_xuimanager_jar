...
public interface IResourceService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IResourceService {
        ...
        /* loaded from: classes.dex */
        private static class Proxy implements IResourceService {
            ...
            public long getDownloadedBytesById(long id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(id);
                    this.mRemote.transact(Stub.TRANSACTION_getDownloadedBytesById, _data, _reply, 0);
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
                } finally {
            ...
            public long getDownloadedBytesByUrl(String url) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(url);
                    this.mRemote.transact(Stub.TRANSACTION_getDownloadedBytesByUrl, _data, _reply, 0);
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
                } finally {
            ...
            public long getTotalBytesById(long id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(id);
                    this.mRemote.transact(Stub.TRANSACTION_getTotalBytesById, _data, _reply, 0);
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
                } finally {
            ...
            public long getTotalBytesByUrl(String url) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(url);
                    this.mRemote.transact(Stub.TRANSACTION_getTotalBytesByUrl, _data, _reply, 0);
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
                } finally {
            ...
            public List<ResourceDownloadInfo> queryAllInfo() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_queryAllInfo, _data, _reply, 0);
                    _reply.readException();
                    List<ResourceDownloadInfo> _result = _reply.createTypedArrayList(ResourceDownloadInfo.CREATOR);
                    return _result;
                } finally {
            ...
            public void removeLocalDataByUrl(String url) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(url);
                    this.mRemote.transact(Stub.TRANSACTION_removeLocalDataByUrl, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void removeLocalDataById(long id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(id);
                    this.mRemote.transact(Stub.TRANSACTION_removeLocalDataById, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public String getLocalFilePath(String url) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(url);
                    this.mRemote.transact(Stub.TRANSACTION_getLocalFilePath, _data, _reply, 0);
                    _reply.readException();
