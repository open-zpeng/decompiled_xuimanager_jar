...
public class ConditionManager implements XUIManagerBase {
    ...
    public void onXUIDisconnected() {
        this.mTwilightStateListeners.forEach(new Consumer() { // from class: com.xiaopeng.xuimanager.condition.-$$Lambda$ConditionManager$ndCyLJJqeEssyv057xLy_aZlWLM
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ConditionManager.lambda$onXUIDisconnected$1(ConditionManager.this, (ConditionManager.TwilightStateListener) obj);
            }
        });
    }

    public static /* synthetic */ void lambda$onXUIDisconnected$1(ConditionManager conditionManager, TwilightStateListener l) {
        try {
            conditionManager.unregisterTwilightStateListener(l);
        } catch (Exception e) {
            String str = TAG;
    ...
    private void initTwilightStateUnregisterListener() throws XUIServiceNotConnectedException {
        if (this.mTwilightStateListeners.isEmpty() && this.mTwilightListenerToService != null) {
            try {
                this.mService.unregisterTwilightStateListener(this.mTwilightListenerToService);
                this.mTwilightListenerToService = null;
            } catch (RemoteException e) {
                String str = TAG;
    ...
    private void initBrightnessLevelUnregisterListener() throws XUIServiceNotConnectedException {
        if (this.mBrightnessLevelListeners.isEmpty() && this.mBrightnessLevelToService != null) {
            try {
                this.mService.unregisterBrightnessLevelListener(this.mBrightnessLevelToService);
                this.mBrightnessLevelToService = null;
            } catch (RemoteException e) {
                String str = TAG;
                Log.e(str, "Could not unregister: " + e.toString());
