...
/* renamed from: android.media.audioConfig.AudioConfig  reason: case insensitive filesystem */
/* loaded from: classes.dex */
public class C0000AudioConfig {
    ...
    /* renamed from: android.media.audioConfig.AudioConfig$AudioServiceListener */
    /* loaded from: classes.dex */
    ...
    public C0000AudioConfig(Context context) {
    ...
    public C0001SoundFieldData getSoundField(int mode) {
        AudioManager audioManager = this.mAudioManager;
        if (audioManager != null) {
            SoundField data = audioManager.getSoundField(mode);
            if (data == null) {
                return new C0001SoundFieldData(0, 0);
            }
            return new C0001SoundFieldData(data.x, data.y);
        }
        return null;
    }
    ...
    /* renamed from: android.media.audioConfig.AudioConfig$XpAudioCallBack */
    /* loaded from: classes.dex */
    private class XpAudioCallBack implements AudioManager.AudioCallBack {
        ...
        public void AudioServiceCallBack(int msg, int value) {
            if (C0000AudioConfig.mAudioServiceListener != null) {
                C0000AudioConfig.mAudioServiceListener.AudioServiceCallBack(msg, value);
            }
        }

        public void onErrorEvent(int errorCode, int operation) {
            if (C0000AudioConfig.mAudioServiceListener != null) {
                C0000AudioConfig.mAudioServiceListener.onErrorEvent(errorCode, operation);
            }
        }
    }
